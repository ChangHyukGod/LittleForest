    ...
    <div class="container">
        ...
        <form action="listForm" name="listForm" method="get">
            ...
            <div class="btn-group mb-3 gap-3" style="margin-bottom: 20px;" role="group" aria-label="Button group with links">
                <a href="#" class="btn btn-light" onclick="fn_genre_ALL()">#전체</a> <a href="#" class="btn btn-light" onclick="fn_genre_RPG()">#RPG</a> <a href="#" class="btn btn-light" onclick="fn_genre_INDY()">#인디</a> <a href="#" class="btn btn-light" onclick="fn_genre_SHOOTING()">#슈팅</a>
