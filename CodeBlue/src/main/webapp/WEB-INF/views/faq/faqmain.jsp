...
function fnMovetoDirect(){
	document.directForm.action="/faqdirect";
			...
			<div class="card" id="last-card">
				<div class="card-body">
					<p class="card-title" data-bs-toggle="modal" data-bs-target="#mo-last-2" id="last-card-title">
						<i class="bi bi-chat-left-dots"></i> 직접 문의하기
					</p>
					<p class="last-card-body-2">담당 직원에게 직접 물어보시면 빠르게 답변해드립니다.</p>
					<form name="directForm">
						<button type="button" class="btn btn-outline-success" id="mail-button" onclick="fnMovetoDirect()">
							<i class="bi bi-chat-text"></i> 문의 게시판
						</button>
					</form>
				</div>
			</div>
			...
			<div class="modal fade" id="mo-1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						...
						<a href="/faqlogin?searchKeyword=비밀" class="btn btn-outline-success" id="card_button">#계정관리</a>
			...
			<div class="modal fade" id="mo-6" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						...
						<a href="/faqlogin?searchKeyword=비밀" class="btn btn-outline-success" id="card_button">#계정관리</a> <a href="/faqlogin?searchKeyword=계정" class="btn btn-outline-info" id="card_button_2" onclick="fnMovetouselimited">#이용제한</a>
					</div>
				</div>
			</div>
				...
				<div class="modal fade" id="mo-2-1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							...
							<a href="/faqlogin?searchKeyword=계정" class="btn btn-outline-info" id="card_button_2" onclick="fnMovetouselimited">#이용제한</a>
						</div>
					</div>
				</div>
				...
				<div class="modal fade" id="mo-3-1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							...
							<a href="/faqlogin?searchKeyword=결제" class="btn btn-outline-warning" id="card_button" onclick="fnMovetobuy()">#결제/환불</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="modal fade" id="mo-4-1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							...
							<a href="/faqlogin?searchKeyword=무단" class="btn btn-outline-danger" id="card_button" onclick="fnMovetoright()">#권리보호</a>
						</div>
					</div>
				</div>
			</div>
